...
import static com.ofo.searchservice.security.ApplicationPermission.OFO_ADMIN;
import static com.ofo.searchservice.security.ApplicationPermission.OFO_USER;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/restaurant/search").hasAnyAuthority(OFO_USER.name(), OFO_ADMIN.name())
                        .anyRequest()
                        .authenticated());
