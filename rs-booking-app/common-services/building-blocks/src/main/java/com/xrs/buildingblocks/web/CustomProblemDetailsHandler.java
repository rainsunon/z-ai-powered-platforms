package com.xrs.buildingblocks.web;
 ...
 * @apiNote
 */
import com.xrs.buildingblocks.core.exception.BadRequestException;
import com.xrs.buildingblocks.core.exception.ConflictException;
import com.xrs.buildingblocks.core.exception.NotFoundException;
...
public class CustomProblemDetailsHandler extends ResponseEntityExceptionHandler {
    ...
    private final Logger logging= LoggerFactory.getLogger(CustomProblemDetailsHandler.class);
    ...
    public ResponseEntity<ProblemDetail> handleAllExceptions(
        ...
        logging.atError().addKeyValue("details", JsonConverterUtils.serializeObject(details)).log("An error occurred while processing the request.");
