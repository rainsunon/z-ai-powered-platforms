...
public class JwtTestUtils {
    ...
    public String generateJwt(UUID userId, String email) {
        return generateJwt(userId, email, List.of("ROLE_USER"), null);
    }

    public String generateJwt(UUID userId, String email, List<String> roles) {
        return generateJwt(userId, email, roles, null);
    }

    public String generateJwt(UUID userId, String email, List<String> roles, Boolean emailVerified) {
