...
* The original package name 'com.github.xrs.immo-finder.rent-service' is invalid and this project uses 'com.github.xrs.immo_finder.rent_service' instead.
...
```
$ docker run --rm -p 8080:8080 rent-service:0.0.1-SNAPSHOT
```
