package com.xrs.commerce.flight.grpcserver;
...
import com.xrs.commerce.flight.flights.features.getflightbyid.GetFlightByIdQuery;
import com.xrs.commerce.flight.seats.dtos.SeatDto;
import com.xrs.commerce.flight.seats.features.Mappings;
import com.xrs.commerce.flight.seats.features.getavailableseats.GetAvailableSeatsQuery;
import com.xrs.commerce.flight.seats.features.reserveseat.ReserveSeatCommand;
import io.grpc.stub.StreamObserver;
import net.devh.boot.grpc.server.service.GrpcService;
import java.util.List;
import java.util.UUID;
import static com.xrs.commerce.flight.flights.features.Mappings.toFlightResponseDtoGrpc;
import static com.xrs.commerce.flight.seats.features.Mappings.toSeatResponseDtoGrpc;
