package com.xrs.multitenant.service;

import com.xrs.multitenant.api.dto.CreateUserRequest;
import com.xrs.multitenant.api.dto.UserResponse;
import com.xrs.multitenant.domain.UserEntity;
import com.xrs.multitenant.kafka.UserEventsProducer;
import com.xrs.multitenant.repo.UserRepository;
import com.xrs.multitenant.tenant.TenantContext;
...
public class UserService {
  ...
  @Cacheable(cacheNames = "users", key = "'tenant:' + T(com.xrs.multitenant.tenant.TenantContext).requireTenantId() + ':user:' + #id")
   ...
   */
  @Transactional
  @CacheEvict(cacheNames = "users", key = "'tenant:' + T(com.xrs.multitenant.tenant.TenantContext).requireTenantId() + ':user:' + #id")
