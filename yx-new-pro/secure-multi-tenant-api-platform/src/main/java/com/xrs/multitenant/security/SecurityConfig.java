package com.xrs.multitenant.security;

import com.xrs.multitenant.observability.CorrelationIdFilter;
import com.xrs.multitenant.security.jwks.JwksKeyRing;
...
public class SecurityConfig {
  ...
  public JwtDecoder jwtDecoder(JwtProperties props, JwksKeyRing keyRing) {
    ...
    NimbusJwtDecoder decoder = NimbusJwtDecoder.withJwkSetUri("http://localhost:8080/.well-known/jwks.json").build();
