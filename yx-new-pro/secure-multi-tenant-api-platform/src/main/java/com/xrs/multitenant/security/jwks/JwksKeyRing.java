package com.xrs.multitenant.security.jwks;

import com.xrs.multitenant.security.JwtProperties;
...
public class JwksKeyRing {
  ...
  public JwksKeyRing(JwtProperties props, ResourceLoader resourceLoader) {
    ...
    List<JWK> jwkKeys = new java.util.ArrayList<>();
    for (RSAKey key : keys) {
      jwkKeys.add(key);
    }
    this.publicJwkSet = new JWKSet(jwkKeys);
  }
