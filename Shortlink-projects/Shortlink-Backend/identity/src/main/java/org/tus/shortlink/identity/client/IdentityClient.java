 ...
 * This interface allows Gateway and other modules to call Identity Service without directly
 * depending on Identity Service implementation.
 *
 ...
 * <p>Usage:
 * <ul>
 *     <li>Gateway: Call validateToken() to resolve user from token</li>
...
public interface IdentityClient {
     ...
     * In the future, this can be replaced with HTTP/gRPC client calls
     * when Identity Service is deployed as a separate service.
     *
