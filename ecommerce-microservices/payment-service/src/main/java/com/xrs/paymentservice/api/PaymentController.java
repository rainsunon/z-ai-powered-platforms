package com.xrs.paymentservice.api;

import com.xrs.paymentservice.dto.OrderDto;
import com.xrs.paymentservice.dto.PaymentDto;
import com.xrs.paymentservice.http.HeaderGenerator;
import com.xrs.paymentservice.service.PaymentService;
import com.xrs.paymentservice.service.impl.PaymentServiceImpl;
...
public class PaymentController {
    ...
    public Mono<ResponseEntity<PaymentDto>> update(@RequestBody
                                                    @NotNull(message = "Input must not be NULL")
                                                    @Valid final PaymentDto paymentDto) {
        log.info("*** PaymentDto, resource; update cart *");
