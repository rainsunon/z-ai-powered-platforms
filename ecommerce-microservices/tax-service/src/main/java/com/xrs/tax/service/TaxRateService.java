...
import com.xrs.tax.model.TaxRate;
import com.xrs.tax.repository.TaxClassRepository;
import com.xrs.tax.repository.TaxRateRepository;
import com.xrs.tax.viewmodel.location.StateOrProvinceAndCountryGetNameVm;
import com.xrs.tax.viewmodel.taxrate.TaxRateGetDetailVm;
import com.xrs.tax.viewmodel.taxrate.TaxRateListGetVm;
import com.xrs.tax.viewmodel.taxrate.TaxRatePostVm;
import com.xrs.tax.viewmodel.taxrate.TaxRateVm;
...
public class TaxRateService {
    ...
    public TaxRateListGetVm getPageableTaxRates(int pageNo, int pageSize) {
        ...
        final List<Long> stateOrProvinceIds =
            taxRates.stream().distinct().map(el -> el.getStateOrProvinceId()).toList();
