    ...
    <div className="space-y-12 max-w-6xl mx-auto pb-20">
      ...
      <section className="flex flex-col md:flex-row justify-between items-end gap-6">
        <div>
          ...
          <h2 className="text-5xl font-extrabold font-headline tracking-tight text-on-surface mb-2">Manage Family Members</h2>
          <p className="text-on-surface-variant text-lg max-w-xl">View and manage your household members, switch profiles, and monitor account status.</p>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {familyMembers.map((member) => (
            <div key={member.id} className="bg-surface-container-lowest rounded-[2rem] shadow-sm overflow-hidden hover:shadow-xl hover:shadow-on-surface/5 transition-all duration-500 group">
              {/* Gradient Header */}
              ...
              <div className="p-6 space-y-4">
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="bg-surface-container rounded-xl p-3">
                    <p className="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest">Vaccination</p>
                    <p className={`font-headline font-bold mt-1 text-sm ${member.vaccination === 'Up to date' ? 'text-primary' : 'text-tertiary'}`}>{member.vaccination}</p>
                  </div>
                </div>
                {/* Status */}
