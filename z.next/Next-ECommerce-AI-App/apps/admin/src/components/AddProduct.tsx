...
const fetchCategories = async () => {
  const res = await fetch(
    `${process.env.NEXT_PUBLIC_BACKEND_APIGATEWAY_URL}/api/categories`
  );
...
const AddProduct = () => {
  ...
  const mutation = useMutation({
    mutationFn: async (data: z.infer<typeof ProductFormSchema>) => {
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_APIGATEWAY_URL}/api/products`,
        {
          method: "POST",
                                ...
                                onChange={async (e) => {
                                  ...
                                  if (file) {
                                    try {
                                      ...
                                      const res = await fetch(
                                        `https://api.cloudinary.com/v1_1/dtikhifms/image/upload`,
                                        {
                                          method: "POST",
                                          body: formData,
                                        }
