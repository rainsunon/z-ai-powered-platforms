...
import com.xrs.userservice.model.dto.request.Login;
import com.xrs.userservice.model.dto.request.SignUp;
import com.xrs.userservice.model.dto.response.TokenValidationResponse;
...
import com.xrs.userservice.security.validate.AuthorityTokenUtil;
import com.xrs.userservice.service.EmailService;
import com.xrs.userservice.service.UserService;
import com.xrs.userservice.security.validate.TokenValidate;
...
public class UserAuth {
    ...
    public Mono<ResponseMessage> register(@Valid @RequestBody SignUp signUp) {
        return userService.register(signUp)
                ...
                .onErrorResume(error -> Mono.just(new ResponseMessage("Error occurred while creating account.")));
    }
