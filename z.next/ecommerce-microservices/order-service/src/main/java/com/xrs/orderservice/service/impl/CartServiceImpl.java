...
import com.xrs.orderservice.helper.CartMappingHelper;
import com.xrs.orderservice.repository.CartRepository;
import com.xrs.orderservice.repository.OrderRepository;
// import com.xrs.orderservice.security.JwtTokenFilter; // TODO: JwtTokenFilter class doesn't exist
import com.xrs.orderservice.service.CartService;
        ...
        return Mono.fromSupplier(() -> cartRepository.findAll()
                ...
                .flatMap(cartDtos -> Flux.fromIterable(cartDtos)
                        .flatMap(cartDto ->
                                ...
                                // callAPI.receiverUserDto(cartDto.userDto().id(), JwtTokenFilter.getTokenFromRequest())
                                callAPI.receiverUserDto(cartDto.userDto().id(), null)
